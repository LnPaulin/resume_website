    ...
    >
      ...
      <div className="w-full flex flex-col items-center md:px-10">
        ...
        <p className="pt-8 w-4/5 opacity-70 text-lg md:text-xl text-center">
          ...
          <a href="https://www.linkedin.com/in/paulin-tf/" target="_blank" className="text-cerulean font-medium hover:underline">Linkedin</a>
          {" "}
        </p>
      </div>
      <a href="mailto:tchiofonkwa@gmail.com" className="w-fit group flex items-center justify-center gap-2 mx-auto mt-8">
        <svg
        ...
        <p className="text-xl font-medium group-hover:text-cerulean duration-300 mb-[5px]">tchiofonkwa@gmail.com</p>
      </a>
    </div>
  )
}
